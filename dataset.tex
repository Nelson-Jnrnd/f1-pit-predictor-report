...
On peut observer en figure \ref{LapTime_distribution_pitStatus} l'impact de la transformation de la variable cible sur la distribution des temps de tours.

\fig[H, width=0.7\textwidth]{\label{LapTime_distribution_pitStatus}Distribution des temps de tours en fonction de la variable cible}{LapTime_distribution_pitStatus.svg}
